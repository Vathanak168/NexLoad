...
_local_download_dir = os.path.join(os.path.expanduser("~"), "Downloads", "NexLoad")
_cloud_download_dir = os.path.join(tempfile.gettempdir(), "NexLoad")
DEFAULT_DOWNLOAD_DIR = os.environ.get("DOWNLOAD_DIR", _cloud_download_dir if _cloud_runtime else _local_download_dir)
